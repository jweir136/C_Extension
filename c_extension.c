...
static PyMethodDef module_methods[] = {
        {"dot_product_optimized_parallel", (PyCFunction) dot_product_optimized_parallel, METH_VARARGS, "Calculates dot product of two matrices"}
};
...
PyObject* dot_product(PyObject* self, PyObject* args) {
    ...
    mat1_rows = PyObject_Length(mat1);
    mat1_cols = PyObject_Length(PyList_GetItem(mat1, 0));
    mat2_rows = PyObject_Length(mat2);
    mat2_cols = PyObject_Length(PyList_GetItem(mat2, 0));
...
PyMODINIT_FUNC initc_extension(void) {
    Py_InitModule3("c_extension", module_methods, "mod doc");
}